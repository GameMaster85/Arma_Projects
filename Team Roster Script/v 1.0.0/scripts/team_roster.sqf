...
// ***********************************************************************************************************************************************
	...
	//===================== Parameters =====================//
	//======================================================//
	_cycle_time = 121; // Time between each update of the list in seconds, shorter values provide more accuracy but may decrease FPS and memory, each loop is "Logged" in diary
	_diary_subject = "Team Roster"; // Text to be shown as the subject in the Map Screen, like Notes and Units.
	_arma_group = true; // Toggles whether to show Arma Group ID (ex. B 1-1-A), true is on and false is off(Most useful when you have already included group in description)
